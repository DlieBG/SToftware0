...
$dateiname="log/log_".$monate[$monat]."_$jahr.$format";
...
$server = [
  ['Schwering Software', 'https://benedikt-schwering.de/SToftware0/html/mobile/call.php'],
        ...
        <p>
          <div class="row">
            <div class="input-field col s10">
              <form id="form" method="POST" action="<?php echo($serverURL); ?>" autocomplete="off" target="iframe">
